...
export class ApartmentComponent implements OnInit {
  ...
  constructor(private postsService: PostsService, public dialog: MatDialog,private pipeProd: PipeService) {}
  ...
  rangeMore3000Change() {
    ...
    } else this.productList1 = this.productList2;
  }
  onSearch() {
  ...
  openBidDialog(id1, productsId1, usersId1, biddingPrice1, timeToBid1): void {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        // this.bidList1[id].biddingPrice =
        //   parseInt(this.bidList1[id].biddingPrice) + 200;
        // this.postsService
        //   .updateBid(id, this.bidList1[id])
        //   .subscribe(data => {});
      }
    });
  }
